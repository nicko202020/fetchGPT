...
def create_rooms_and_graph():
    global graph, living_room, kitchen
    
    # Initialize the graph
    graph = Graph()

    # Define room boundaries for Living Room and Kitchen so they are adjacent
    ...
    # Position the fifth node (LR5) near the edge close to the Kitchen
    ...
    # Position the fifth node (K5) near the edge close to the Living Room
    ...
    # Connect Living Room and Kitchen via their adjacent edge nodes
