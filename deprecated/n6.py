...
def create_rooms_and_graph():
    global graph, living_room, kitchen, dining_room, study_room, library, office
    
    # Initialize the graph
    graph = Graph()

    # Define room boundaries
    living_room = Room("living room", 100, 100, 400, 400, graph)
    kitchen = Room("kitchen", 400, 100, 700, 400, graph)
    dining_room = Room("dining room", 400, 400, 700, 700, graph)
    study_room = Room("study room", 100, 400, 400, 700, graph)
    library = Room("library", 700, 250, 1000, 550, graph)
    gym = Room("gym", 1000, 250, 1300, 550, graph)
    # Add nodes and edges within Living Room
    living_room.add_node("lr1", (150, 150))
    living_room.add_node("lr2", (350, 150))
    living_room.add_node("lr3", (150, 350))
    living_room.add_node("lr4", (350, 350))
    living_room.add_node("lr5", (350, 250))  # Node near the boundary towards the Kitchen
    ...
    # Add nodes and edges within Kitchen
    kitchen.add_node("k1", (450, 150))
    kitchen.add_node("k2", (650, 150))
    kitchen.add_node("k3", (450, 350))
    kitchen.add_node("k4", (650, 350))
    kitchen.add_node("k5", (450, 250))  # Node near the boundary towards the Living Room
    ...
    # Add nodes and edges within Dining Room
    dining_room.add_node("d1", (450, 450))
    dining_room.add_node("d2", (650, 450))
    dining_room.add_node("d3", (450, 650))
    dining_room.add_node("d4", (650, 650))
    dining_room.add_node("d5", (450, 550))  # Node near the boundary towards the Kitchen
    ...
    # Add nodes and edges within Study Room
    study_room.add_node("s1", (150, 450))
    study_room.add_node("s2", (350, 450))
    study_room.add_node("s3", (150, 650))
    study_room.add_node("s4", (350, 650))
    study_room.add_node("s5", (350, 550))  # Node near the boundary towards the Living Room
    ...
    # Add nodes and edges within Library
    library.add_node("l1", (750, 300))
    library.add_node("l2", (950, 300))
    library.add_node("l3", (750, 500))
    library.add_node("l4", (950, 500))
    library.add_node("l5", (700, 400))  # Node on the left vertical edge for connections
    library.add_edge("l1", "l2")
    library.add_edge("l2", "l4")
    library.add_edge("l3", "l4")
    library.add_edge("l1", "l3")

    # Add nodes and edges within Gym
    gym.add_node("g1", (1050, 300))
    gym.add_node("g2", (1250, 300))
    gym.add_node("g3", (1050, 500))
    gym.add_node("g4", (1250, 500))
    gym.add_edge("g1", "g2")
    gym.add_edge("g2", "g4")
    gym.add_edge("g3", "g4")
    gym.add_edge("g1", "g3")

    # Connect Library to adjacent rooms (Kitchen and Study Room) and Gym
    graph.add_edge("k4", "l5")  # Assuming k4 is on the right vertical edge of Kitchen
    graph.add_edge("s4", "l5")  # Assuming s4 is on the right vertical edge of Study Room
    graph.add_edge("l2", "g1")  # Connection between Library and Gym
...
def get_path(destination):
    """Calculates a path to a specified destination, which can be a room, a node, or an item."""
