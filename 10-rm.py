...
def create_rooms_and_graph():
    ...
    graph.add_edge("k6", "b5")  # Connecting Kitchen to Bedroo
    ...
    bedroom.add_edge("b1", "b5")
    bedroom.add_edge("b5", "b3")
    bedroom.add_edge("b3", "b4")
    bedroom.add_edge("b2", "b4")
    graph.add_edge("b4", "ba2")  
    ...
    bathroom.add_edge("ba1", "ba5")
    bathroom.add_edge("ba3", "ba5")
